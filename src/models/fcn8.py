...
class FCN8(nn.Module):
    def __init__(self, n_classes):
        ...
        # torch.Size([1, 256, 270, 480])
        # torch.Size([1, 512, 135, 240])
        # torch.Size([1, 1024, 68, 120])
        # torch.Size([1, 2048, 34, 60])
    ...
    def forward(self, x):
        ...
        self.discriminative_al_features = x
        # print(x.shape)
        y.append(x)
