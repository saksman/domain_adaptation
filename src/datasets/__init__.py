...
from . import fish_clf, fish_reg, fish_loc, fish_seg, gta5, cityscapes
...
def get_dataset(dataset_name, root=None, split=None, transform=None, 
                datadir=None, n_samples=None, habitat=None):
    ...
    if dataset_name == "fish_clf":
        ...
        dataset = gta5.GTA5DataSet(root=root, split=None,
                              transform=transform,
                              datadir=datadir, 
                              n_samples=n_samples)
    
    elif dataset_name == "cityscapes":
        dataset = cityscapes.CityscapesDataSet(root=root, split=split,
                              transform=transform,
                              datadir=datadir, 
                              n_samples=n_samples)
    # ===========================================================
    ...
    if dataset_name == "tiny_fish_clf":
        ...
        dataset = fish_seg.FishSeg(split="train"+ "/Segmentation/",
                              transform=transform,
                              datadir=datadir, 
                              n_samples=10,
                              habitat=habitat)
...
def get_transformer(transform, split):
    ...
    if transform == "gta5_cityscapes_none":
        return transforms
